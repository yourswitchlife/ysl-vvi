...
import styles from './coupon-test.module.scss'
  ...
  return (
    ...
    {/* 電腦版 */}
      ...
      >
        ...
        >
          <div className="col-3">
            <Image src={logo} alt='YSL coupon logo' width={70} height={70} />
          </div>
          ...
          <div className="col-9 row">
            ...
            <div className='col-12 row justify-content-around align-items-center'>
              <span className={`text-white d-none d-md-block col-1 p-0 d-flex align-items-center fs-1 `}>$</span>
              
              <h1 className={`${styles.font} text-white d-none d-md-block col-5 p-0 me-3`}>100</h1>

              <button className={`${styles.btnCTA} btn btn-lg btn-danger ms-3 col-6}`}>
      ...
      {/* 手機板 */}
      <div
        className="d-block d-md-none grid text-center row d-flex justify-content-center w-100 m-auto mt-4"
      >
        ...
        >
          ...
          <div className="col-9 row">
            ...
            <div className="d-flex justify-content-center align-items-center">
              ...
              <button className={`${styles.btnCTA} btn btn-sm btn-danger col-5 ms-5`}>
