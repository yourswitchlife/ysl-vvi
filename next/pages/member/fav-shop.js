        ...
        <>
            ...
            <div className={mStyle.bodyClass + ' d-flex'}>
                ...
                <div className="container d-flex flex-column  align-items-center pt-5">
                    ...
                    <div className={mStyle.product_card + ' container d-flex flex-column align-items-center pb-5 bg-white mb-5'}>
                    <div className={fpStyle.page_check +" pt-5"}>
                        ...
                        {/* 迴圈 */}
                        <div className={styles.seller_frame + " d-flex justify-content-between align-items-center mb-2"}>

                            <div className={styles.seller_xs + " d-flex mb-4 mt-3 justify-content-center flex-grow-1"}>
                                {/* seller detail */}
                                ...
                                <div className="d-flex flex-column align-items-center justify-content-center ms-3">
                                    <div className='d-flex align-items-center'>
                                        <div className={styles.wid_xs + ' d-flex justify-content-center align-items-center flex-wrap'}>
                                        <h4 className={styles.h4text_xs+"  pe-5 fw-bold"}>碧姬公主的玩具城堡</h4>
                                        <h6 className={styles.h6text_xs}>@princepeach8888</h6>
                                        </div>

                                        <div className={styles.column+" d-flex align-items-center ps-5"}>
                                            {/* star rating */}
                                            
                                            <h5 className={styles.h6text_xs + ' me-2'}>5.0</h5>
                                            <div className={styles.h6text_xs + ' text-warning pe-5'}><FaStar className='me-1' /><FaStar className='me-1' /><FaStar className='me-1' /><FaStar className='me-1' /><FaStar className='me-1' />
                                            </div>
                                    ...
                                    <div className={styles.sellers + " d-flex justify-content-between align-items-center"}>
                                        {/* little dashboard */}
                                        <div className={styles.padding_xs + " d-flex flex-column align-items-center pe-5"}>
                                            <h5 className={styles.h6text_xs + ' text-secondary'}>商品數量</h5>
                                            <h5 className={styles.h6text_xs + ' text-secondary'}>28</h5>
                                        </div>
                                        <div className={styles.padding_xs + " d-flex flex-column align-items-center pe-5"}>
                                            <h5 className={styles.h6text_xs + ' text-secondary'}>已賣出件數</h5>
                                            <h5 className={styles.h6text_xs + ' text-secondary'}>18</h5>
                                        </div>
                                        <div className={styles.padding_xs+ " d-flex flex-column align-items-center pe-5"}>
                                            <h5 className={styles.h6text_xs + ' text-secondary'}>關注人數</h5>
                                            <h5 className={styles.h6text_xs + ' text-secondary'}>186</h5>
                                        </div>

                                        <Button
                                            type="button"
                                            className={styles.cancle_xs +" btn btn-danger d-flex align-items-center"}
                                        >
