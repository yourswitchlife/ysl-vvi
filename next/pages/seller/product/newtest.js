    ...
    <>
      <div className={`mb-4 ${styles.dashboardStyle}`}>
        ...
        >
          <div className="row">
            ...
            <div className="mb-3 col-lg-6 col-12 d-flex ">
              <label htmlFor="pLanguage" className="h6 me-2 flex-shrink-0">
                <h5 className="text-dark">
            ...
            {/* 商品描述 */}
            <div className="mb-3 col-12 d-flex justify-content-center align-items-center">
              <label htmlFor="pDiscribe" className="h6 me-2 flex-shrink-0">
                <h5 className="text-dark">
        ...
        {/* <Form
          ...
          onSubmit={handleNewP}>
          <div className="mb-3 col-12 d-flex justify-content-center align-items-center">
            <Form.Label htmlFor="pName" className="mb-1 me-2 flex-shrink-0">
              <h5 className="text-dark">
                商品名稱<span className="text-danger">*</span>
              </h5>
            </Form.Label>
          ...
          <div className="mb-3 col-12 d-flex justify-content-center align-items-center">
            <Form.Label htmlFor="pCover" className="mb-1 me-2 flex-shrink-0">
              <h5 className="text-dark">
                商品封面照<span className="text-danger">*</span>
              </h5>
            </Form.Label>
          ...
          <div className="mb-3 col-12 d-flex justify-content-center align-items-center">
            <Form.Label
              htmlFor="pImgs"
              className="mb-1 me-2 flex-shrink-0 d-flex align-items-end"
            >
              <h5 className="text-dark mb-0">商品詳細照</h5>
              <p className="text-secondary mb-1">
                (1~3張)<span className="text-danger h5">*</span>
